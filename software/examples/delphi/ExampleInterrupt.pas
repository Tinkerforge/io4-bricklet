...
type
  ...
  private
    ...
    io: TBrickletIO4;
  public
    procedure InterruptCB(sender: TObject; const interruptMask: byte; const valueMask: byte);
    procedure Execute;
  end;
...
procedure TExample.InterruptCB(sender: TObject; const interruptMask: byte; const valueMask: byte);
begin
